...
fun Main(
    ...
    Column(
        ...
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            Column(modifier = Modifier.fillMaxHeight(0.8f), verticalArrangement = Arrangement.SpaceBetween) {
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                Box(
                    ...
                    Box(
                        ...
                        Row(
                            ...
                            Image(modifier = Modifier.size(30.dp), painter = painterResource(id = R.drawable.ic_squad), contentDescription = null)
                            Spacer(modifier = Modifier.fillMaxWidth(0.05f))
                            Text(text = "스쿼드", fontSize = 30.sp, fontWeight = FontWeight.Bold, color = Color.Black)
                        }
                    }
                }
            }
